...
<x-app-layout>
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        <h1 class="display-5 fw-bold lh-1 mb-3 text-white">Пользователь не найден</h1>
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        <a href="/" class="btn btn-primary btn-lg px-4 me-md-2" role="button" aria-pressed="true">На главную</a>
